  ...
  return (
    <>
      ...
      <header className="absolute top-5 left-0 w-full z-50 px-6 md:px-24 py-6 flex justify-between items-center">
        <div className="text-white text-xl font-light flex gap-1 z-50">
      ...
      >
        ...
        <div className="h-full flex justify-between p-12">
          ...
          <div className="space-y-6 text-sm mt-70 mr-10 text-black">
            <div>
              <h4 className="uppercase font-bold mb-2">OPEN HOURS</h4>
              <ul className="space-y-1">
                <li>Monday-Friday | 2pm-2am</li>
                <li>Saturday-Sunday | 11am-2am</li>
              </ul>
            </div>
            <div>
